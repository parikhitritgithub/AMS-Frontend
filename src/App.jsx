...
import ScientistProposalDetails from "./components/proposal/ScientistProposalDetails"; // Add this import
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Scientist Proposal Details - NEW ROUTE */}
        <Route
          path="/scientist/project/:id"
          element={scientistGuard(<ScientistProposalDetails onLogout={handleLogout} />)}
        />
        ...
        <Route
          ...
          element={adminGuard(<AdminProposalDetails onLogout={handleLogout} />)}
        />
