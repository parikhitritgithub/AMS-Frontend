import { ArrowLeft, Edit, Save, X, CheckCircle, XCircle, Clock, Calendar, User, Mail, Building, FileText, DollarSign, Users, TrendingUp, RefreshCw, AlertTriangle, Eye } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
          <div>
            ...
            <p className="text-sm text-gray-500">
              <span className="font-mono">Project Code: {proposal.uniqueCode || proposal.id?.slice(-8).toUpperCase()}</span>
          ...
          <InfoCard title="Similarity Analysis" icon={TrendingUp}>
            ...
            {proposal.similarityMatches && proposal.similarityMatches.length > 0 && (
              <div className="mt-4">
                ...
                <div className="space-y-2">
                  {proposal.similarityMatches.map((match, idx) => (
                    <div key={idx} className="bg-gray-50 rounded-lg p-2">
                      <p className="text-xs font-medium text-gray-700 truncate">{match.title}</p>
                      <div className="flex justify-between items-center mt-1">
                        <span className="text-xs text-gray-500">{match.uniqueCode}</span>
